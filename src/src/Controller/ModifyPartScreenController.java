            ...
            if (minValid(min, max) && inventoryValid(min, max, stock)) {
                ...
                if (inhouseRadioButton.isSelected()) {
                    try {
                        ...
                        InhousePart newInHousePart = new InhousePart(modifiedPartId, name, price, stock, min, max, machineId);
                    ...
                    try {
                        ...
                        OutsourcedPart newOutsourcedPart = new OutsourcedPart(modifiedPartId, name, price, stock, min, max,
                                companyName);
